...
const Login = () => {
  ...
  return (
    <div className='grid lg:grid-cols-2 sm:grid-cols-1 px-2'>
        ...
        <div className='grid w-full py-3'>
          ...
          <div className=' flex justify-center py-3 w-full'>
            <form onSubmit={handleSubmit} className='grid gap-2'>
              ...
              <button className=' mt-2 py-2 rounded-lg cursor-pointer bg-blue-600 font-semibold'>{loading ? "Logging in..." : "Login"}</button>
            </form>
          </div>
      ...
      <div className='hidden lg:flex min-h-screen justify-center flex-col items-center pt-4'>
